...
Public profiles: #link("https://github.com/EricBoittier")[GitHub], #link("https://scholar.google.ch/citations?hl=en&user=pAQXUFcAAAAJ")[Google Scholar], #link("https://www.linkedin.com/in/ericboittier")[LinkedIn].
...
- RDKit bug fixes across C++ and Python bindings, including merged PR #link("https://github.com/rdkit/rdkit/pull/7811")[#7811]
